...
(definec len2 (x :tl) :nat
  (if (endp x) 0 (1+ (len2 (rest x)))))

(definec new-base-help-measure (denom :pos base-factors :lop) :nat
  (+ denom (len2 base-factors)))
...
(definec new-base-will-terminate-help (denom :pos base-factors :lop) :bool
  ...
  (declare (xargs :measure (if (and (posp denom) (lopp base-factors) (not (in2 1 base-factors))) (new-base-help-measure denom base-factors) 0)
